 ...
 * read queries take no arguments; the two GOS-111 work-execution mutations
 * take only `engagementId` — ownership/role is always derived from
 * `@CurrentUser()`, never passed in.
 */
@Resolver()
